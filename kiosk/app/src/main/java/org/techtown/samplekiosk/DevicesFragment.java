...
public class DevicesFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listAdapter = new ArrayAdapter<ListItem>(getActivity(), 0, listItems) {
            ...
            public View getView(int position, View view, @NonNull ViewGroup parent) {
                ...
                TextView text1 = view.findViewById(R.id.text101);
                TextView text2 = view.findViewById(R.id.text102);
                if(item.driver == null)
    ...
    public void onListItemClick(@NonNull ListView l, @NonNull View v, int position, long id) {
        ...
        if(item.driver == null) {
            ...
            Intent args = new Intent(getActivity(), UsbService.class);

            args.putExtra("device", item.device.getDeviceId());
            args.putExtra("port", item.port);
            args.putExtra("baud", baudRate);
            args.putExtra("withIoManager", withIoManager);

            Toast.makeText(getActivity(), "Device Selected", Toast.LENGTH_SHORT).show();
            getActivity().startService(args);
